...
namespace els::cpro2::common::platform::gui::fonts
{
   ...
   public:
      ...
      const void *get_glyph_bitmap(lv_font_glyph_dsc_t * g_dsc, uint32_t unicode_letter, std::vector<uint8_t> &draw_buf);
...
#if LV_VERSION_CHECK(8, 0, 0)
      lv_font_glyph_dsc_t cached_glyph_dsc_;
      uint32_t cached_letter_;
#endif
   };

}  // namespace els::cpro2::common::util::gui::fonts
